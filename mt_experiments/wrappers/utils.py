...
def visualize_alti(total_alti, source_sentence, target_sentence, predicted_sentence, word_level, alignment, figsize=(17, 24), layer='all'):
    ...
    if layer == 'all':
        ...
        if word_level:
            if alignment:
                ...
                tokens_out = predicted_sentence
            print('contributions_rollout_layer_np', contributions_rollout_layer_np.shape)
            contributions_rollout_layer_np, words_in, words_out = align.contrib_tok2words(
                contributions_rollout_layer_np,
                tokens_in=(source_sentence + target_sentence),
                tokens_out=tokens_out
